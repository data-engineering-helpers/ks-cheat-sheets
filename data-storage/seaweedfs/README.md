...
[This cheat sheet](https://github.com/data-engineering-helpers/ks-cheat-sheets/blob/main/data-storage/seaweedfs/README.md)
explains how to install and to use SeaweedFS service on premises, _e.g._,
on a laptop or on a virtual machine (VM).

> SeaweedFS is an independent Apache-licensed open source project with its
> ongoing development made possible entirely thanks to the support of
> awesome [backers](https://github.com/seaweedfs/seaweedfs/blob/master/backers.md)
...
* [SeaweedFS home page](https://seaweedfs.com/)
* [GitHub - SeaweedFS](https://github.com/seaweedfs/seaweedfs)
