#!/usr/bin/env python
#
# File: https://github.com/data-engineering-helpers/ks-cheat-sheets/blob/main/data-processing/spark/examples/001-scd2-w-delta/src/001_scd2_w_delta/jobs/merge_customer_004_sc_w_uc.py
#
...
def processCustomerInit(spark: SparkSession):
    ...
    try:
        ...
        # and does not work either when Spark connects to Spark Connect (SC),
        # itself connected to Unity Catalog. See also merge_customer_002_uc_only.py
