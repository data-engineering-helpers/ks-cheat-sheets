...
* [GitHub - PyEnv repository](https://github.com/pyenv/pyenv)

#### Uvicorn

* [Uvicorn home page](https://uvicorn.dev/)
* [GitHub - Uvicorn repository](https://www.github.com/Kludex/uvicorn)

### uv

* [GitHub - uv repository](https://github.com/astral-sh/uv)
* [Astral doc - uv](https://docs.astral.sh/uv/guides/projects/)
* [Astral doc - Publishing guide](https://docs.astral.sh/uv/guides/publish/)
* Motto: A single tool to replace `pip`, `pip-tools`, `pipx`, `poetry`,
  `pyenv`, `twine`, `virtualenv`, and more

### Ruff

* [GitHub - Ruff project](https://github.com/astral-sh/ruff)
* [Astral doc - Ruff page](https://docs.astral.sh/ruff)
...
3.12.12 (main, Oct 12 2025, 18:37:51) [Clang 17.0.0 (clang-1700.3.19.1)]
```

### Install a new Python version

* Retrieve the latest list of Python versions, filtering for some specific
  minor version, say `3.12`:
...
* Install a specific version of Python, say `3.12.12`:
...
* To uninstall a specific version of Python, say the `3.12.11`,
...
* [GitHub - Astral - uv reference](https://github.com/astral-sh/uv?tab=readme-ov-file#projects)
...
* [GitHub - Astral - uv reference](https://github.com/astral-sh/uv?tab=readme-ov-file#scripts)
...
* [GitHub - Astral - uv reference](https://github.com/astral-sh/uv?tab=readme-ov-file#tools)

#### uv - Python versions

* [GitHub - Astral - uv reference](https://github.com/astral-sh/uv?tab=readme-ov-file#python-versions)

#### uv - pip interface

* [GitHub - Astral - uv reference](https://github.com/astral-sh/uv?tab=readme-ov-file#the-pip-interface)
...
* Thus far, we have been using Ruff's default configuration. Let us take a
  [look at how we can customize Ruff's behavior](https://docs.astral.sh/ruff/tutorial/#configuration)
...
1. Automatic installer (Recommended):
   ...
   * For more details visit the
   [PyEnv installer project](https://github.com/pyenv/pyenv-installer)
